<x-app-layout>
    ...
    <style>
        .box-dash {
            background-image: url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='20' ry='20' stroke='black' stroke-width='4' stroke-dasharray='6%2c 14' stroke-dashoffset='10' stroke-linecap='square'/%3e%3c/svg%3e");
            border-radius: 20px;
        }
    </style>
    <!-- Header Section -->
    ...
    <div class="relative">
        <div class="col-md-8 mt-[30px] md:mt-[40px] lg:mt-[55px] xl:mt-[78px] mx-auto">
            <div
                class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[20px] sm:gap-[20px] md:gap-[40px] lg:gap-[50px]">
                @foreach ([
        [
            'main_image' => '1.png',
            'hover_image' => '2.png',
        ...
        [
            ...
            'rounded' => false,
                    ...
                    <div class="flex flex-col xl:p-[18px] lg:p-[15px] md:p-[12px] p-[10px] box-dash">
    ...
    {{-- ending button --}}
    <div class="my-[20px] md:my-[40px] xl:my-[80px]">
        <div class="flex justify-center items-center py-5">
            <button
                class="px-[17px] py-[8px] bg-[#094AB7] text-white text-[15px] font-semibold rounded-[5px] font-monti">
                Load More
            </button>
        </div>
    </div>
