...
@section('content')
        ...
        <div
            ...
            <p
                class="text-white text-[18px] sm:text-[20px] lg:text-[30px] xl:text-[40px] 2xl:text-[50px]
                      font-bold font-monti xl:leading-[60px] ">
    ...
    <div
        ...
        <div class="relative mb-[10px]">
            ...
            <h2
                class="text-[18px] sm:text-[24px] lg:text-[30px] font-bold font-monti text-[#094AB7] xl:leading-[46px] ">
                Strikers edged out Team Zalmi by 3 runs in a high-stakes match filled with dramatic moments.
            </h2>
        </div>
        <div class="">
            <p
                class="font-medium font-monti lg:text-[16px] md:text-[14px] text-[12px] xl:leading-[46px] text-[#0D0C22] opacity-75">
        ...
        <p
            class="font-medium font-monti lg:text-[16px] md:text-[14px] text-[12px] xl:leading-[46px] text-[#0D0C22] opacity-75 mt-[10px]">
            Fan Reactions</p>
        <ul
            class="list-disc pl-4 space-y-2 text-[#17109E] opacity-75 font-monti lg:text-[16px] md:text-[14px] text-[12px] mt-[10px]">
        ...
        <div class="flex flex-col justify-between lg:flex-row xl:mt-0 lg:mt-3 lg:gap-0 min-[365px]:gap-3">
            <p class="mt-6 text-[#09154B] font-monti lg:text-[16px] md:text-[14px] text-[12px]">Stay tuned for more
                updates and
                analysis from the
                world of cricket!</p>
            <div class="flex justify-center lg:justify-end 2xl:gap-[44px] xl:gap-[20px] lg=:gap-3 min-[365px]:gap-4 ">
                <button
                    class="2xl:px-6 2xl:py-[11px] xl:px-4 xl:py-[6px] lg:px-3 lg:py-[2px] min-[365px]:px-5 min-[365px]:py-[4px] bg-[#094AB7] text-white 2xl:text-[14px] xl:text-[11px] lg:text-[9px] min-[365px]:text-[10px] font-monti font-normal ">❮
                    Previous Post</button>
                <button
                    class="2xl:px-6 2xl:py-[11px] xl:px-4 xl:py-[6px] lg:px-3 lg:py-[2px] min-[365px]:px-5 min-[365px]:py-[4px] bg-[#094AB7] text-white 2xl:text-[14px] xl:text-[11px] lg:text-[9px] min-[365px]:text-[10px] font-monti font-normal">Next
                    Post ❯</button>
            </div>
        </div>
    </div>
