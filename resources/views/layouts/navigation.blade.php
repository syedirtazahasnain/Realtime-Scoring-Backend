    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Matches -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('t1.matches')" :active="request()->routeIs('t1.matches')">
                    {{ __('Matches') }}
                </x-nav-link>
            </div>
                ...
                <!-- Teams -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('t1.teams')" :active="request()->routeIs('t1.teams')">
                    {{ __('Teams') }}
                </x-nav-link>
            </div>
                ...
                <!-- Drafting -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <x-nav-link :href="route('drafting')" :active="request()->routeIs('drafting')">
                    {{ __('Drafting') }}
                </x-nav-link>
            </div>
